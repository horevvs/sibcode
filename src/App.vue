  ...
  <div>
    <div>
      <div class="d-flex  rounded-circleflex-row mt-3 mx-3 mb-3">
        <div  v-on:click="Hide" class="m-3 p-2 w-25 rounded text-center bg-secondary fs-5">
          <router-link  to="/"
        ...
        <div v-on:click="Hide" class="m-3 p-2 w-25 rounded text-center bg-secondary fs-5">
          <router-link
            to="/smm"
            class="link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover"><div>Smm</div>
          </router-link>
        </div>
    ...
    <router-link to="/add">
    <button  v-on:click="visible7 = !visible7" type="button" class="btn btns btn-secondary link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover"> Добавить проект</button>
    </router-link>
