<template>
    ...
    <ul>
        ...
        <img  style=""  class="img1" src="../images/vk_1.png" alt="3">
    </ul>
    ...
    <ul>
        ...
        <img  style=""  class="img1" src="../images/topvisor_1.png" alt="4">
        <li>Id пользователя так же берется в настройках аккаунта</li>
        <img  style=""  class="img1" src="../images/topvisor_2.png" alt="5">
        <li>Как получить проект id показанно на рисунке ниже</li>
        <img  style=""  class="img1" src="../images/topvisor_3.png" alt="">
        <li>Как получить проект id региона показанно на рисунке ниже. Id красноярска 87, томска 93</li>
        <img  style=""  class="img1" src="../images/topvisor_5.png" alt="">
        <li>Название группы берется из списка групп</li>
        <img  style=""  class="img1" src="../images/topvisor_4.png" alt="">
    </ul>
    <div class="add_page-header">Яндекс пример заявку в директ</div>
    <ul>
        <img  style=""  class="img1" src="../images/direct_example-1.png" alt="">
        <img  style=""  class="img1" src="../images/direct_example-2.png" alt="">
    </ul>
    ...
    <ul>
        ...
        <img  style=""  class="img1" src="../images/direct-1.png" alt="">
        <li>Вот мы и получили ClientID</li>
        <img  style=""  class="img1" src="../images/direct-2.png" alt="">
